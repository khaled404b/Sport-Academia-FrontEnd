...
const EventCalendarAcA = ({ navigation,route }) => {
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity       onPress={() => navigation.navigate('EventDetailsAcA', { event: item ,academia})}
    >
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Button onPress={fetchEvents} mode="contained" color="#6200ee">Retry</Button> // Change the color of the button
          </View>
        </View>
      </Modal>
    </View>
  ...
  const styles = StyleSheet.create({
    ...
    container: {
      flex: 1,
      backgroundColor: '#403F9D', // Change the background color to a light gray
      padding: 10,
    },
    header: {
      padding: 15,
      backgroundColor: '#6200ee', // Change the background color to a purple
      flexDirection: 'row',
      alignItems: 'center',
