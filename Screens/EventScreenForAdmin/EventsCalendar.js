...
const EventsCalendar = ({ navigation }) => {
  ...
  const NoData = () => (
    <View style={styles.noData}>
      <Text>No events found. Why not create a new one?</Text>
      <Button onPress={() => navigation.navigate('AddEditEventScreen')} mode="contained">Create Event</Button>
    </View>
  );
  ...
  return (
    ...
    />
      <FAB
        ...
        label="Add Event"
        icon="plus"
        onPress={() => navigation.navigate('AddEditEventScreen')}
      />
      <Modal
        animationType="slide"
        transparent={true}
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Button onPress={fetchEvents} mode="contained">Retry</Button>
          </View>
        </View>
      </Modal>
    </View>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    marginBottom: 12,  // Added marginBottom for spacing
  },
  headerTitle: {
    color: 'blue',
    fontSize: 21,
