...
const GuestFootballList = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchFootballAcademies = async () => {
      try {
        const response = await fetch(`${API_URL}/getFootballAcademies`);
        if (!response.ok) {
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <Animated.View style={[styles.contentContainer, { opacity: fadeAnim }]}>
        <Text style={styles.title}>Football Academies</Text>
...
const styles = StyleSheet.create({
  ...
  export default GuestFootballList;
